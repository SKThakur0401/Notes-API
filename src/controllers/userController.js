...
const dotenv= require("dotenv").config()        // So that now we can access " .env " variables present in our environment variable
const bcrypt = require("bcrypt")            // For encryption and decryption

const  jwt= require("jsonwebtoken")         // for token generation..
const SECRET_KEY= process.env.SECRET_KEY                // secret key for "token-generation"
